...
- **Живой сайт:** https://mraleksby.github.io/CRMBMK/
- **Локальная папка:** `/Users/Aleks/Documents/CRMBMK`
- Деплой автоматический при `git push` в `main` → GitHub Actions → ветка `gh-pages`
...
- `BrowserRouter` должен иметь `basename="/CRMBMK"` — иначе роутинг сломается на GitHub Pages
